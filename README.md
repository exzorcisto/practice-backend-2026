...
1. **Фильтрация списка опросов (Активные / Завершенные):**
![Скриншот фильтрации опросов](./public/screen_filter_answers.png)

1. **Работа пагинации при большом количестве данных:**
![Скриншот пагинации](./public/screen_paginate.png)

1. **Сортировка опросов по популярности (Количеству ответов):**
